            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 2:</span> LESSON 3 Plating and Holding Sandwiches
                </h1>
              </div>
              ...
              <div className="video-description" style={{
                ...
                Plating sandwiches includes making sure that it will be as appealing visually as it is in terms of taste. Diners eat with their eyes first, that why it is important that the sandwiches look attractive and delicious.                </p>
                <p style={{ marginBottom: "15px" }}>
                As a member of the kitchen staff, another thing that you should be concerned about is the proper storage of sandwiches and other ingredients in order to keep them safe for consumption until they are to be serve or used for sandwich-making. Storage procedures and proper storage conditions vary depending on the contents of the sandwich and also the composition of the different elements used in preparing sandwiches.</p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Guidelines for Plating Sandwiches</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Holding and Storing Sandwiches</a>
                  </li>
                </ul>
              </div>
...
export default PlatingSandwiches;