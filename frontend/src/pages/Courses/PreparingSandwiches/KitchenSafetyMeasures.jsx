  ...
  const handleNextLessonClick = async () => {
    try {
      ...
      const response = await axios.post(
        ...
        { lessonName: 'KitchenSafetyMeasures' },
        {
          headers: {
            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 1:</span> LESSON 3 Observing Kitchen Safety and Sanitation Measures
                </h1>
              </div>
              ...
              <div className="video-description" style={{
                ...
                Sandwich may include both cooked and uncooked ingredients. These ingredients are usually made ready-to-eat as they are prepared for sandwich-making. For this reason, you should observe safety and sanitation measures to ensure that sandwiches are safe for the diners to eat. You, as a kitchen staff, are also responsible in keeping yourself and your co-workers safe while working in the kitchen.                </p>
                <p style={{ marginBottom: "15px" }}>
                In this lesson, we will present you important sanitation and personal safety measures you can observe while preparing sandwiches.</p>
              </div>
            </div>
...
export default KitchenSafetyMeasures;