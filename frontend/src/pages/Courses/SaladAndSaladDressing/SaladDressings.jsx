            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 2:</span> Preparing Salad Dressings
                </h1>
              </div>
              ...
              <div className="video-description" style={{
                ...
                Dressings are accompaniments prepared to make the salad more appetizing. They are used to add moisture, flavor visual appeal to the salad.
                </p>
                <h6><span style={{ fontFamily: "'Nunito', sans-serif", fontWeight: "bold"}}>When choosing the type of dressing to be used, you must consider the:</span></h6>
                <ul>
                  ...
                  <li>Service sequence (if serving in or next to the salad); and the</li>
                  <li>Compatibility of the dressing to the flavor of the salad.</li>
                </ul>
                <p style={{ marginBottom: "15px", }}>  
                Most salad dressings are made of fat and acid combined together through the process of emulsification. In this method, fats and acids, such as vinegars and oils, are mixed or shaken vigorously to mix the two unmixables. The harder the ingredients are beaten or shaken, the longer they will stay combined.
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Preparing Oil and Acid-based Dressings</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Balsamic Vinaigrette</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Preparing Mayonnaise-based Dressings</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Guidelines for Preparing Mayonnaise-based Dressings</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 3: Preparing Other Types of Salad Dressings</a>
                  </li>
                </ul>
              </div>
