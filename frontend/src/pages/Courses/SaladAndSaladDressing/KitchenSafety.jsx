...
const Quiz = ({ onQuizComplete }) => {
  ...
  const allQuestions = [
    {
      question: "What is the main purpose of salad dressings?",
      options: ["To change the temperature of the salad", "To preserve the salad for longer periods", "To add moisture, flavor, and visual appeal", "To cook the salad ingredients"],
      correctAnswer: "To add moisture, flavor, and visual appeal"
    },
    {
      question: "What kind of emulsion is created by oil and acid-based dressings like vinaigrette?",
      options: ["Permanent emulsion", "Partial emulsion", "Temporary emulsion", "Chemical emulsion"],
      correctAnswer: "Temporary emulsion"
    },
    {
      question: "What ingredient in mayonnaise helps bind oil and acid together permanently?",
      options: ["Vinegar", "Egg yolk", "Mustard", "Sugar"],
      correctAnswer: "Egg yolk"
    },
    {
      question: "Which of the following is NOT a common oil and acid-based dressing?",
      options: ["Sauce Gribiche", "Tomato French Dressing", "Vinaigrette", "Caesar Dressing"],
      correctAnswer: "Caesar Dressing"
    },
    {
      question: "What are some ingredients used as a base in other types of salad dressings aside from oil or mayonnaise?",
      options: ["Flour and baking powder", "Butter and cream cheese", "Cream products and fruit purees", "Eggs and cornstarch"],
      correctAnswer: "Cream products and fruit purees"
    },
            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 1:</span> LESSON 2 Observing Kitchen Safety and Sanitation Measures
                </h1>
              </div>
              ...
              <div className="video-container" style={{ 
                ...
                <div style={{
                  ...
                  <iframe 
                    ...
                    src="https://www.youtube.com/embed/rvprTwku4c4?si=P-K1jQAhr8JBJ8eJ" 
              ...
              <div className="video-description" style={{
                ...
                Preparing salads and dressings involves adherence to food safety standards and performing sanitation and safety practices. A professional kitchen staff is required to maintain a high standard personal safety and sanitation.
                </p>
                <p style={{ marginBottom: "15px" }}>
                Another important role of the kitchen staff is to make sure that the ingredients purchased are in their best condition and that food are prepared in a manner that it will be safe for human consumption.
                </p>
                <p style={{ marginBottom: "15px" }}>
                This lesson will present guidelines for preparing the workstation according to food safety standards as well as the safe and proper ways of handling common salads and dressings ingredients.
                </p>
                <h6><span style={{ fontFamily: "'Nunito', sans-serif", fontWeight: "bold"}}>At the end of this unit, you should be able to:</span></h6>
                <ul>
                  <li>Define salads and dressings;</li>
                  <li>Determine the components of a salad;</li>
                  <li>Identify common salad ingredients;</li>
                  <li>Observe personal sanitation and safety measures in the kitchen; and</li>
                  <li>Handle salad ingredients properly and safely.</li>
                </ul>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Keeping the Kitchen Food-safe and Sanitized</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Personal Safety Measures in the Kitchen</a>
                  </li>
                </ul>
              </div>
