            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 2:</span> LESSON 2 Preparing Salads
                </h1>
              </div>
              ...
              <div className="video-description" style={{
                ...
                Salads can be categorized based on the ingredient each is mainly made of. Common types of salads include the:
                </p>
                <ul>
                  <li>Green salads;</li>
                  <li>Vegetable salads;</li>
                  <li>Starch salads;</li>
                  <li>Compound salads;</li>
                  <li>Fruits salads; and</li>
                  <li>Composed salads.</li>
                </ul>
                <p style={{ marginBottom: "15px", }}>  
                The following topics will give you a background on the common salad types as well as important reminders for preparing each one.
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Preparing Green Salads</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Preparing Mesclun Salad</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Preparing Vegetable and Starch Salads</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 3: Compound Salads</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Preparing Beet and Potato Salad</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 4: Fruit Salads</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 5: Composed Salads or Salad Composé</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Preparing Salad Niçoise</a>
                  </li>
                </ul>
              </div>
