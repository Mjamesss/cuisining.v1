    ...
    return (
      <nav aria-label="breadcrumb" className="px-3 px-md-5" style={{ 
        ...
        <ol className="breadcrumb" style={{ 
          ...
          <li className="breadcrumb-item"><a href="/SaladAndSaladDressing" style={{ color: "black", textDecoration: "none" }}>Salads and Salad Dressings</a></li>
          <span style={{ margin: "0 10px" }}>&gt;</span>
...
const Quiz = ({ onQuizComplete }) => {
  ...
  const allQuestions = [
    {
      question: "What type of salad is served in small portions with fresh and crisp ingredients to stimulate the palate?",
      options: ["Main course salad", "Accompaniment salad", "Appetizer salad", "Separate course salad"],
      correctAnswer: "Appetizer salad"
    },
    {
      question: "What is the ideal storage temperature for salad greens?",
      options: ["25–30ºF", "35–40ºF or 15–20ºC", "41–45ºF", "Room temperature"],
      correctAnswer: "35–40ºF or 15–20ºC"
    },
    {
      question: "Which of the following should you AVOID when selecting vegetables for salads?",
      options: ["Crisp leafy vegetables", "Brightly colored produce", "Refrigerated cut vegetables", "Vegetables with bruises or signs of decay"],
      correctAnswer: "Vegetables with bruises or signs of decay"
    },
    {
      question: "What should be done before storing salad greens to keep them fresh?",
      options: ["Soak them in water", "Wrap them in foil", "Wash under cold running water and dry with paper towels", "Freeze immediately"],
      correctAnswer: "Freeze immediately"
    },
    {
      question: "What indicates that pickled items are NOT safe to use in a salad?",
      options: ["They are resting in clear liquid", "They are free from off-odor and mold", "The container is chipped and the liquid is black or cloudy", "They are firm to the touch"],
      correctAnswer: "The container is chipped and the liquid is black or cloudy"
    },
            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 2:</span> LESSON 3 Plating and Storing Salads and Salad Dressings
                </h1>
              </div>
              ...
              <div className="video-container" style={{ 
                ...
                <div style={{
                  ...
                  <iframe 
                    ...
                    src="https://www.youtube.com/embed/LwhhI6km-A8?si=oyyHwUOwOsa5zBIB" 
              ...
              <div className="video-description" style={{
                ...
                Salads and their dressings can be arranged and plated in many different ways. Several factors need to be considered when determining how salads will presented. The most common ones as the following:
                </p>
                <ul>
                  <li>Salad type – Some salad types have distinct arrangements and presentations. Tradionally, composed salads look different from a bound salads;</li>
                  <li>Ingredients used – The quality of ingredients need to kept until the salad is taken by the diners. Some element may affect the texture, color and flavor of other items when added too early or arranged improperly;</li>
                  <li>Service style – The way meals are served also affect how salads are presented. In a buffet set-up, salads may be arranged on serving dishes for the guests to serve themselves. In a French or a spoon and fork service, salads are commonly arranged in front of the guests; and</li>
                  <li>Function – What the salad is being served and when it will be served also affect the presentation of a salad. Appetizer salads need to be arranged in small portions while salads to be served as the main course or a separate dish should be served in a filling portion.</li>
                </ul>
                <p style={{ marginBottom: "15px", }}>  
                There are also times when the salads need to be prepared and plated beforehand to accommodate the demand of the dining operation. Such instances call for special measures to ensure the quality of salads and dressing during holding and storing.
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Common Salad Plating Styles</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Guidelines for Plating Salads and Salad Dressings</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Holding and Storing Salads and Salad Dressings</a>
                  </li>
                </ul>
              </div>
