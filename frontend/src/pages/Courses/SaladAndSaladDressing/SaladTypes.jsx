  ...
  const handleNextLessonClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_BACKEND_LINK || "http://localhost:5000"}/api/course/SaladAndSaladDressing/update`,
        { lessonName: 'SaladTypes' },
        {
          headers: {
            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 1:</span> LESSON 1 Types and Components of Salads
                </h1>
              </div>
              ...
              <div className="video-description" style={{
                ...
                Generally, a salad is defined as a mixture of raw and/or cooked ingredients usually combined with a dressing and served cold.
                </p>
                <h6><span style={{ fontFamily: "'Nunito', sans-serif", fontWeight: "bold"}}>Salads are versatile menu items. They can be served as:</span></h6>
                <ul>
                  <li>Appetizers – made of fresh and crisp ingredients with palette-stimulating flavors arranged attractively and served in small portions;</li>
                  <li>Accompaniments – composed of starch-rich or sweet food items served as a side dish for the main course;</li>
                  <li>Main course – large servings of salad containing protein-rich ingredients in balance proportion with the variety of other food items used; and</li>
                  <li>Separate course – fruit salads or other light green salads served to after the main course intended to cleanse the pallet before the dessert is served.</li>
                </ul>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Components of a Salad</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Common Salad Ingredients</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Salad Greens</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Vegetables</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Fruits</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Protein-rich Products</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Starch-rich Products</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Herbs</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Acids and Oils</a>
                  </li>
                </ul>
              </div>
