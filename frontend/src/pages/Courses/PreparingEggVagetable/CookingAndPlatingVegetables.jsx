  ...
  const handleNextLessonClick = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/course/PreparingEggVegetable/update', {
        lessonName: 'CookingAndPlatingVegetables'
      }, {
        headers: {
...
const CookingAndPlatingVegetables = () => {
            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 2:</span> LESSON 3 Cooking and Plating Vegetables
                </h1>
              </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Boiling and Steaming Vegetables</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Sautéing Vegetables</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 3: Braising and Stewing Vegetables</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 4: Grilling and Broiling Vegetables</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 5: Frying Vegetables</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 6: Cooking Large Quantities of Vegetables</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 7: Checking Vegetables for Doneness</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 8: Guidelines for Plating Vegetable Dishes</a>
                  </li>
                </ul>
              </div>
...
export default CookingAndPlatingVegetables;