...
const Quiz = ({ onQuizComplete }) => {
  ...
  const allQuestions = [
    {
      question: "What is the main purpose of an appetizer?",
      options: ["To act as a dessert", "To replace the main dish", "To stimulate one’s appetite", "To cleanse the palate before dessert"],
      correctAnswer: "To stimulate one’s appetite"
    },
    {
      question: "What is the French term that refers to a small bite-sized appetizer served after the order is taken?",
      options: ["Hors d’oeuvre", "Entrée", "Amuse-bouche", " Charcuterie"],
      correctAnswer: "Amuse-bouche"
    },
    {
      question: "Which of the following characteristics indicates high-quality bread for appetizers?",
      options: ["Thick crust and sour aroma", "Hard, tough texture with no air pockets", "Thin, golden-brown crust that springs back when pressed", "Very smooth dough without bubbles"],
      correctAnswer: "Thin, golden-brown crust that springs back when pressed"
    },
    {
      question: "When selecting fresh shrimp or prawns for appetizers, which characteristic should be present?",
      options: ["Bright red shells with no head", "Firm shells, grey color, and heads intact", "Soft shells and a sweet smell", "Pink shells and curled tails"],
      correctAnswer: "Firm shells, grey color, and heads intact"
    },
    {
      question: "Which of the following is NOT a sign of high-quality pickled vegetables for appetizers?",
      options: ["Clear pickling liquid", "Mushy texture", "Free from molds", "No strong or off odor"],
      correctAnswer: "Mushy texture"
    },
  ];
            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 1:</span> Lesson 1 Types Of Appetizers and Hors d'oeuvres
                </h1>
              </div>
              ...
              <div className="video-container" style={{ 
                ...
                <div style={{
                  ...
                  <iframe 
                    ...
                    src="https://www.youtube.com/embed/zpHD4VEih1c?si=Iuh7ei5A-JUvpgsE" 
              ...
              <div className="video-description" style={{
                ...
                An appetizer is a small food item intended to stimulate one’s appetite. Generally, an appetizer is defined as the first dish in a multi-course, sit-down meal traditionally prepared by the garde manger (gard-mahn-zhey) or the pantry chef.
                </p>
                <p style={{ marginBottom: "15px" }}>
                The word appetizer is now being used interchangeably with the term hors d’oeuvres (awr-durv). In classic French dining, hors d’oeuvres are small food items served on passed-around trays or on attractively-arranged platters during receptions and cocktail events.
                </p>
                <p style={{ marginBottom: "15px" }}>
                Another French term used to refer to appetizers is amuse bouche (ah-mooz-boosh) or amuse gueule (ah-mooz-gœl) which means “gratify the mouth”. Amuse-bouche or amuse-gueule is usually a smaller version of a dish served after the order was taken.
                </p>
                <p style={{ marginBottom: "15px" }}>
                From being just the first dish in a multi-course meal, appetizers are now also being served as individual dishes, not connected to a meal, during events and gatherings.
                </p>
                <h6><span style={{ fontFamily: "'Nunito', sans-serif", fontWeight: "bold"}}>At the end of this unit, you should be able to:</span></h6>
                <ul>
                  <li>Prepare common types of appetizers properly;</li>
                  <li>Plate and serve common appetizer dishes according to standards; and</li>
                  <li>Identify the current trend in plating appetizer dishes.</li>
                </ul>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Common Types of Appetizers and Hors d’oeuvres</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Common Appetizer and Hors d’oeurve Ingredients</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Baked Items</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Protein-Rich Products</a>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Fresh and Pickled Vegetables</a>
                  </li>
                </ul>
              </div>
...
export default TypesOfAppetizers;