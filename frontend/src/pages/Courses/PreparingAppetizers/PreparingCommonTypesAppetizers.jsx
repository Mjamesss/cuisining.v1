            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 2:</span> Lesson 1 Preparing Common Types of Hors d'oeuvres
                </h1>
              </div>
              ...
              <div className="video-description" style={{
                ...
                The list of appetizer and hors d’oeuvre recipes including the variations is almost endless. And the number of these recipes continues to rise day after day.
                </p>
                <p style={{ marginBottom: "15px" }}>
                This will help you take part in discovering new appetizer and hors d’oeuvre dishes by letting you know how to prepare some of the most common appetizer and hors d’oeuvre recipes.
                </p>
