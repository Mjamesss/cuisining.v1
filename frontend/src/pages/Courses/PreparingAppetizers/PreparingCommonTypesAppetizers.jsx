  ...
  const handleNextLessonClick = async () => {
    try {
      ...
      const response = await axios.post(
        ...
        { lessonName: 'PreparingAppetizers' },
        { headers: { Authorization: `Bearer ${token}` } }
      );
      

      console.log('Lesson updated:', response.data);
      window.location.href = '/PlatingAppetizers';
    } catch (error) {
...
const PreparingCommonTypesAppetizers = () => {
            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 2:</span> Preparing Common Types of Appetizers and Hors d'oeuvres
                </h1>
              </div>
              ...
              <div className="video-description" style={{
                ...
                Today, the list of appetizer and hors d’oeuvre recipes including the variations is almost endless. And the number of these recipes continues to rise day after day.
                </p>
                <p style={{ marginBottom: "15px" }}>
                This lesson will help you take part in discovering new appetizer and hors d’oeuvre dishes by letting you know how to prepare some of the most common appetizer and hors d’oeuvre recipes.
                </p>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> TOPIC 1: Preparing Canapés</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> • Prosciutto Crostini</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 2: Preparing Tapas</a>
                    <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> • Gazpacho</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> • Prosciutto Crostini</a>
                  </li>
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 3: Preparing Antipasti</a>
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> • Antipasti Platter</a>
                  </li>
                  </li>
                  <li style={{ padding: "8px 0" }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 4: Preparing Cocktails</a>
                  </li>
                </ul>
              </div>
...
export default PreparingCommonTypesAppetizers;