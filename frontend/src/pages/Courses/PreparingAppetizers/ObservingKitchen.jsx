...
const Quiz = ({ onQuizComplete }) => {
  ...
  const allQuestions = [
    ...
    {
      question: "Why should canapés be assembled as close to serving time as possible?",
      options: ["To save time and effort", "To let the flavors develop", "To avoid soggy bases and dry garnishes", "To make them more colorful"],
    ...
    {
      question: "What is bruschette commonly made of?",
      options: ["Fried dough and sweet syrup", "Cheese and crackers", "Bread rubbed with garlic and drizzled with olive oil", "Sliced fruit on a skewer"],
            ...
            <div style={{ flex: 2 }}>
              <div className="content-container" style={{ 
                ...
                <h1 className="unit-title" style={{
                  ...
                  <span style={{ color: "#adb44e", }}>UNIT 1:</span> Observing Kitchen Safety and Sanitation Measures
                </h1>
              </div>
              ...
              <div className="video-description" style={{
                ...
                <p style={{ marginBottom: "15px" }}>
                This lesson will present guidelines for preparing the workstation according to food safety standards as well as the safe and proper ways of handling common appetizer ingredients.
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div className="right-side-container" style={{
                ...
                <ul style={{
                  ...
                  <li style={{ padding: "8px 0",  }}>
                    <a style={{ textDecoration: "none", color: "#000000" }}> Topic 1: Keeping the Kitchen Food-safe</a>
                  </li>
                  <li style={{ padding: "8px 0",  }}>
...
export default ObservingKitchen;