   ...
   useEffect(() => {
    ...
    useEffect(() => {
      ...
      if (token) {
        ...
        // Optional: clean up URL by removing the token
    ...
    return (
        <>
          ...
          {isPayPalModalOpen && (
            <div className="modal-overlay position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center" 
              style={{ zIndex: '1000', backgroundColor: 'rgba(0, 0, 0, 0.5)', backdropFilter: 'blur(5px)' }}>
              <div className="modal-content p-5 position-relative" style={{ 
                ...
                <div className="text-center">
                  ...
                  />
                  <h2 style={{ color: '#2e7d32', marginBottom: '20px' }}>You're Officially Enrolled!</h2>
                  <p style={{ fontSize: '18px', marginBottom: '30px' }}>
                    Welcome to CuiSining Pro! Your payment was successful and your account has been upgraded.
                  </p>
                </div>

                <div style={{ backgroundColor: '#f5f5f5', borderRadius: '10px', padding: '20px' }}>
                  <h3 style={{ color: '#adb44e', marginBottom: '15px' }}>Your Pro Benefits:</h3>
                  <ul style={{ listStyleType: 'none', paddingLeft: '0' }}>
                    <li style={{ padding: '8px 0', borderBottom: '1px solid #eee', display: 'flex', alignItems: 'center' }}>
                      <span style={{ color: '#4caf50', marginRight: '10px' }}>✓</span>
                      Unlock access to all core competencies for NCII Cookery
                    </li>
                    <li style={{ padding: '8px 0', borderBottom: '1px solid #eee', display: 'flex', alignItems: 'center' }}>
                      <span style={{ color: '#4caf50', marginRight: '10px' }}>✓</span>
                    ...
                    <li style={{ padding: '8px 0', borderBottom: '1px solid #eee', display: 'flex', alignItems: 'center' }}>
                      <span style={{ color: '#4caf50', marginRight: '10px' }}>✓</span>
                      Access to all skill sets for comprehensive learning
                    </li>
                    <li style={{ padding: '8px 0', display: 'flex', alignItems: 'center' }}>
                      <span style={{ color: '#4caf50', marginRight: '10px' }}>✓</span>
                      Priority support from our culinary experts
                    </li>
                  </ul>
                </div>
                ...
                <div className="text-center mt-4">
                  <button 
                    ...
                    onMouseOver={(e) => e.target.style.backgroundColor = '#9ca045'}
                    onMouseOut={(e) => e.target.style.backgroundColor = '#adb44e'}
                  >
                    Start Learning Now
                  </button>
                </div>
