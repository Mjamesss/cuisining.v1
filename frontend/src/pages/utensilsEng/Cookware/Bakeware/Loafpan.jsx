...
const Model = (props) => {
    const { scene } = useGLTF("LoafPans.glb"); // Ensure the model is in the public folder
...
const Loafpan = () => {
    return(
       ...
       <a href="Bakeware"><img src="https://res.cloudinary.com/dm6wodni6/image/upload/v1739376994/back_pzol0l.png"></img> </a>
        ...
        <h1 className="font-weight-900">Loaf Pan</h1>
            ...
            Bread and loaf pans are essential to any bakery, sandwich shop, or cafe looking to make house-made specialty bread. Bread pans come in a range of different mold shapes and sizes to be able to create french bread, sandwich rolls, and buns in addition to traditional bread loaves.
             <br></br><br></br>
• Deep construction allows for high rising<br></br>
• Perfect for bread, cake, and pudding<br></br>
