            ...
            <div className="row justify-content-center" style={{ marginTop: "-30px" }}>
                <div className="col-12 col-md-10 col-lg-9">
                    ...
                    <div className="d-grid gap-4" style={{ marginBottom: "100px", gridTemplateColumns: getGridColumns() }}>
                        ...
                        {/* Swivel Peeler */}
                        <a href="Swivel" className="grilling-item text-center" style={{ textDecoration: "none", position: "relative" }}>
                        ...
                        {/* Swiss Peeler */}
                        <a href="Swis" className="grilling-item text-center" style={{ textDecoration: "none", position: "relative" }}>
                        ...
                        {/* Landcashier Peeler */}
                        <a href="Landcashier" className="grilling-item text-center" style={{ textDecoration: "none", position: "relative" }}>
                            <img src="https://res.cloudinary.com/dm6wodni6/image/upload/v1739976652/Group_1000005993_1_oped9j.png" 
                                className="img-fluid hover-shadow" alt="Landcashier Peeler"
                                style={{ clipPath: "inset(0 0 25px 0)" }} />
                            <h1 className="font-weight-800" 
                                style={{ fontSize: "18px", fontFamily: "'Nunito', sans-serif", color: "#000000", position: "absolute", bottom: "10px", 
                                left: "0", right: "0", textAlign: "center", padding: "0 10px", margin: 0 }}>
                        ...
                        {/* Serrated Peeler */}
                        <a href="Serrated" className="grilling-item text-center" style={{ textDecoration: "none", position: "relative" }}>
                        ...
                        {/* Julienne Peeler */}
                        <a href="Julienne" className="grilling-item text-center" style={{ textDecoration: "none", position: "relative" }}>
                        ...
                        {/* Mechanical Peeler */}
                        <a href="Mechanical" className="grilling-item text-center" style={{ textDecoration: "none", position: "relative" }}>
                        ...
                        {/* Rotary Peeler */}
                        <a href="Rotary" className="grilling-item text-center" style={{ textDecoration: "none", position: "relative" }}>
