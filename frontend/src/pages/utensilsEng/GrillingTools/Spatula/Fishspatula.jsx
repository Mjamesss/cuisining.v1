...
const Model = (props) => {
    const { scene } = useGLTF("Fish Spatula.glb"); // Ensure the model is in the public folder
...
const  Fishspatula = () => {
    ...
    return(
       ...
       <a href="Spatula"><img src="https://res.cloudinary.com/dm6wodni6/image/upload/v1739376994/back_pzol0l.png"></img> </a>
        ...
        <h1 className="font-weight-900">Fish Spatula</h1>
            ...
            <br></br><br></br>
Best for: While it’s obviously the go-to tool for cooking fish, this spat is incredibly versatile at flipping everything from pancakes to a sheet tray full of roasted vegetables.
