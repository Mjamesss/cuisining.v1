...
const Model = (props) => {
    const { scene } = useGLTF("Serving Tongs.glb"); // Ensure the model is in the public folder
...
const  Servingtongs = () => {
    ...
    return(
       ...
       <a href="Tongs"><img src="https://res.cloudinary.com/dm6wodni6/image/upload/v1739376994/back_pzol0l.png"></img> </a>
        ...
        <h1 className="font-weight-900">Serving tongs</h1>
