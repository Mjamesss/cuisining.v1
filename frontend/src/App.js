        ...
        <Row>
          <Col>
            <Routes>
              ...
              <Route path="SaladTypes" element={<SaladTypes/>}/>
              <Route path="KitchenSafety" element={<KitchenSafety/>}/>
              <Route path="SaladDressings" element={<SaladDressings/>}/>
              <Route path="PreparingSalad" element={<PreparingSalad/>}/>
              <Route path="PlatingSalad" element={<PlatingSalad/>}/>
