                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-md-10 col-lg-9">
                        ...
                        <div className="d-grid gap-4" style={{ gridTemplateColumns: getGridColumns() }}>
                            <a href="Swivel" className="grilling-item text-center">
                            ...
                            <a href="Swis" className="grilling-item text-center">
                            ...
                            <a href="Landcashier" className="grilling-item text-center">
                                <img src="https://res.cloudinary.com/dm6wodni6/image/upload/v1739976652/Group_1000005993_1_oped9j.png" className="img-fluid hover-shadow" alt="Landcashier Peeler" />
                            </a>
                            <a href="Serrated" className="grilling-item text-center">
                            ...
                            <a href="Julienne" className="grilling-item text-center">
                            ...
                            <a href="Mechanical" className="grilling-item text-center">
                            ...
                            <a href="Rotary" className="grilling-item text-center">
