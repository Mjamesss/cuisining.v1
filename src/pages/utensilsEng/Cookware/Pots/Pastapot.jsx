...
const Pastapot = () => {
    return(
       ...
       <a href="Pots"><img src="https://res.cloudinary.com/dm6wodni6/image/upload/v1739376994/back_pzol0l.png"></img> </a>
        ...
        <h1 className="font-weight-900">Pastapot</h1>
            ...
            <br></br><br></br>
• Features a tall pot and removable perforated basket to hold food<br></br>
• Great for cooking, steaming, and straining pasta, seafood, and veggies<br></br>
